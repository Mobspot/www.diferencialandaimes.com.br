	...
	class FooBox_Free_Exclude {
		...
		function add_metaboxes() {
			...
			foreach ( $post_types as $post_type ) {
				...
				$metabox_title = apply_filters( 'foobox_metabox_title', __( 'FooBox Javascript &amp; CSS', 'foobox-image-lightbox' ) );
		...
		function render_meta_box($post) {
			...
			$metabox_desc_exclude = apply_filters( 'foobox_metabox_desc_exclude', __( 'Exclude FooBox from this page or post? By default, FooBox will be included.', 'foobox-image-lightbox' ) );
